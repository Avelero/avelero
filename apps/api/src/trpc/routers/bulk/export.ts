            ...
            try {
                ...
                try {
                    ...
                    await updateExportJobStatus(brandCtx.db, {
                        ...
                        status: "FAILED",
                        summary: {
                            error: `Failed to start background job: ${triggerError instanceof Error
                    ...
                    throw new Error(
                        `Failed to start background export job. Please ensure Trigger.dev dev server is running. Error: ${triggerError instanceof Error
                            ? triggerError.message
                            : String(triggerError)
                        }`,
                    );
