/**
 * Templates router implementation (top-level).
 *
 * Provides passport template management as a standalone router.
 * Previously nested under passports.templates, now a first-class citizen.
 *
