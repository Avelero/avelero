-- =============================================
-- FIX: Update broadcast_domain_changes for renamed/dropped tables
--
-- Changes from migration 20260117094319_daily_prism.sql:
-- - brand_facilities -> brand_operators (renamed)
-- - brand_eco_claims, product_eco_claims, variant_eco_claims (dropped)
--
-- This migration updates the function to reference the correct table names.
-- =============================================
...
BEGIN
  ...
  CASE TG_TABLE_NAME
    ...
    -- =============================================
    WHEN 'products', 'brand_materials', 'brand_tags',
    ...
    WHEN 'product_variants', 'product_commercial', 'product_weight',
         'product_materials', 'product_environment',
    ...
    WHEN 'product_variant_attributes', 'variant_commercial', 'variant_weight',
         'variant_materials', 'variant_environment',
  ...
  domain_name := CASE TG_TABLE_NAME
    -- Products domain (14 tables - eco_claims tables removed)
    ...
    -- Catalog domain (8 tables - brand_eco_claims removed, brand_facilities -> brand_operators)
...
COMMENT ON FUNCTION realtime.broadcast_domain_changes() IS
  'Broadcasts domain-specific changes for realtime updates with 1-second throttling per domain/scope. Correctly handles DELETE operations and resolves brand_id through foreign keys for child tables. Uses advisory locks and broadcast_throttle table to prevent message flooding during bulk operations. Updated to reflect brand_facilities->brand_operators rename and removed eco_claims tables.';
