...
export const passportTemplatesRelations = relations(
  passportTemplates,
  ({ one, many }) => ({
    passports: many(passports),
    brand: one(brands, {
...
export const brandCertificationsRelations = relations(
  brandCertifications,
  ({ one, many }) => ({
    brand: one(brands, {
...
export const brandCollectionsRelations = relations(
  brandCollections,
  ({ one }) => ({
    brand: one(brands, {
...
export const passportTemplateModulesRelations = relations(
  passportTemplateModules,
  ({ one }) => ({
    passportTemplate: one(passportTemplates, {
...
export const passportModuleCompletionRelations = relations(
  passportModuleCompletion,
  ({ one }) => ({
...
export const brandEcoClaimsRelations = relations(
  brandEcoClaims,
  ({ one, many }) => ({
    brand: one(brands, {
...
export const brandFacilitiesRelations = relations(
  brandFacilities,
  ({ one, many }) => ({
    brand: one(brands, {
...
export const brandMaterialsRelations = relations(
  brandMaterials,
  ({ one, many }) => ({
    brand: one(brands, {
...
export const showcaseBrandsRelations = relations(
  showcaseBrands,
  ({ one, many }) => ({
    brand: one(brands, {
...
export const productJourneyStepsRelations = relations(
  productJourneySteps,
  ({ one }) => ({
...
export const productEnvironmentRelations = relations(
  productEnvironment,
  ({ one }) => ({
    product: one(products, {
...
export const productVariantIdentifiersRelations = relations(
  productVariantIdentifiers,
  ({ one }) => ({
    productVariant: one(productVariants, {
...
export const productEcoClaimsRelations = relations(
  productEcoClaims,
  ({ one }) => ({
...
export const productCareCodesRelations = relations(
  productCareCodes,
  ({ one }) => ({
