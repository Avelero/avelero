  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              A primary integration creates products and populates selected
              fields.
            </p>
          </div>
          {hasPrimary && (
            <div className="flex items-center gap-2 mt-2 p-3 bg-muted">
              ...
              <p className="type-small text-muted-foreground">
                <span className="font-medium">{existingPrimaryName}</span> is
                already the primary integration.
              </p>
            </div>
          )}
        </button>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="type-small text-secondary">
              A secondary integration enriches existing products. It does not
              create products.
            </p>
          </div>
        </button>
      ...
      <div className="flex justify-end">
        <Button
          variant="default"
          onClick={() => onNext(selected === "primary")}
        >
          Next
        </Button>
      </div>
