...
import type { FilterState, SelectionState } from "@/components/tables/passports/types";
                ...
                <div className="px-6 py-6">
                    ...
                    {isInitial && (
                        <div className="space-y-4">
                            ...
                            <p className="type-small text-secondary">
                                Your export will be prepared in the background. You can wait here for the
                                download to complete automatically, or close this dialog and continue
                                working — we'll send you an email with the download link when it's ready.
                            </p>
                        </div>
                    )}
                    ...
                    {isComplete && (
                        <div className="flex flex-col items-center justify-center py-8 gap-4">
                            ...
                            <div className="text-center">
                                <p className="type-p text-foreground font-medium">Export complete!</p>
                                <p className="type-small text-secondary mt-1">
                                    Your download should start automatically. A copy has also been sent to
                                    your email.
                                </p>
                            </div>
                            {statusQuery.data?.downloadUrl && (
                    ...
                    {isFailed && (
                        <div className="flex flex-col items-center justify-center py-8 gap-4">
                            ...
                            <div className="text-center">
                                <p className="type-p text-foreground font-medium">Export failed</p>
                                <p className="type-small text-destructive mt-1">
                                    {(statusQuery.data?.summary as Record<string, unknown>)?.error as string ||
