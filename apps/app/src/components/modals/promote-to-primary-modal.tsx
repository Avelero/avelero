            ...
            <DialogContent className="max-w-[480px] p-0 gap-0 border border-border">
                ...
                <div className="px-6 py-4 space-y-3">
                    <DialogDescription className="text-secondary">
                        Are you sure you want to make <span className="text-foreground !font-medium">{integrationName}</span> your primary integration?
                    </DialogDescription>

                    <ul className="space-y-1 text-secondary type-small list-disc list-inside">
                        <li>Variants will be re-grouped based on {integrationName}'s structure</li>
