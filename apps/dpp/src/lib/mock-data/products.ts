...
export const mockProducts: Record<string, DppData> = {
  ABC123: {
    ...
    description:
      "A timeless wool jacket crafted with sustainable materials and ethical manufacturing practices. This piece combines traditional craftsmanship with modern sustainability standards, ensuring both quality and environmental responsibility. Perfect for those who value style without compromise.",
    size: "M",
    color: "Navy Blue",
    category: "Outerwear",
    ...
    journey: [
      ...
      },
      {
        ...
        companies: [{ name: "Textile Mills Ltd.", location: "Prato, Italy" }],
      },
      {
        name: "Manufacturing",
        companies: [
  ...
  DEF456: {
    ...
    brandName: "Acme Studios",
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelOne_rdcgve.webp",
    description:
      "A premium organic cotton t-shirt that sets the standard for sustainable basics. Made from 100% GOTS certified organic cotton and manufactured in facilities powered by renewable energy. Soft, durable, and kind to the planet.",
    size: "L",
    color: "White",
    category: "Tops",
    ...
    journey: [
      {
        name: "Cotton Farming",
        companies: [{ name: "Organic Farms Co.", location: "Izmir, Turkey" }],
      },
      {
  ...
  GHI789: {
    ...
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelTwo_vglkse.webp",
    description:
      "Premium denim crafted with water-saving techniques and organic materials.",
    size: "XL",
    color: "Indigo",
    category: "Bottoms",
    ...
    impactClaims: ["Water Saving Process", "Organic Certified"],
    similarProducts: [
      {
        image:
          "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelThree_klgnyi.webp",
  ...
  MRM001: {
    ...
    brandName: "Mr. Marvis",
    productImage:
      "https://cdn.mrmarvis.com/images/yb9xf4jc/production/7a1e4f348f55cbaa51647f3330679d10ad12a4d0-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
    description:
      "Ontdek The Fine Cords Baristas: MR MARVIS’ five-pocket design in fijn donkerbeige corduroy, gemaakt van biologisch katoen met een vleugje stretch. Deze broek combineert de rijke look van corduroy met de fit van je favoriete jeans.",
    size: "32 / 34",
    color: "Dark Beige",
    category: "Trousers",
    ...
    similarProducts: [
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/3ceb8d245dcea9c09ff68b7198e49edca79bfdfa-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
      ...
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/f3eafa6adfd14feed4e80d81e5cd575c990d97fa-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
      ...
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/adc7274e1a6bf55c65189ad67c6ea8c30ab53b35-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
      ...
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/300f37fb4813e7594a7acd752341ec6795d092d8-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
      ...
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/42caa90973059ccb0c2aceafb5c6485a00183e68-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
      ...
      {
        image:
          "https://cdn.mrmarvis.com/images/yb9xf4jc/production/82679f7e664487026dd374c8aa1a046ddc671d38-2000x3000.jpg?w=1000&h=1500&q=80&fit=min&auto=format",
  ...
  MRM002: {
    ...
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelFour_bjqsyy.webp",
    description:
      "Luxuriously soft cashmere sweater made entirely from recycled materials. By choosing recycled cashmere, we save precious resources while maintaining the highest quality standards.",
    size: "M",
    color: "Charcoal Gray",
    category: "Knitwear",
  ...
  MRM003: {
    ...
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937033/AIModelFive_l0dh6e.webp",
    description:
      "Durable and stylish backpack crafted from organic hemp canvas with recycled leather accents.",
    size: "One Size",
    color: "Natural Beige",
    ...
    journey: [
      ...
      },
      {
        ...
        companies: [{ name: "Ethical Goods Co.", location: "Pokhara, Nepal" }],
      },
    ],
    impactMetrics: [
      {
    ...
    impactClaims: ["Fair Wages", "Organic Materials", "Biodegradable"],
    similarProducts: [
      {
        image:
          "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937033/AIModelSix_btqjzc.webp",
  ...
  FP001: {
    ...
    productImage:
      "https://www.fillingpieces.com/cdn/shop/files/8720133225652-2_96ce2c02-3aa5-44da-9eec-5ee8bc4fcff1.jpg",
    description:
      "Embrace nature with the Loafer Bonsai Black, a seasonal version of our iconic Patch-Loafer line. Adorned with a chenille and embroidery patch featuring the Bonsai graphic, it reflects love and care for this special tree. Crafted from luxury polido leather with a cow-leather lining, this loafer offers exceptional quality and comfort for every occasion.",
    size: "43",
    color: "Black",
    category: "Loafers",
    ...
    journey: [
      {
        name: "Weaving",
        companies: [{ name: "Artisan Weavers", location: "Porto, Portugal" }],
      },
      {
        name: "Manufacturing",
        companies: [
    ...
    similarProducts: [
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/8720133500117-2.jpg?v=1756217452&width=2120",
      ...
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/8720133499725-1_1.jpg?v=1758276875&width=2120",
      ...
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/8720133591917.jpg?v=1757320785&width=2120",
      ...
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/8720133499626-2_2f01ae5c-eda3-4b8d-ade5-dd61d73eba4b.jpg?v=1756226633&width=2120",
      ...
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/8720133503149.jpg?v=1757320675&width=2120",
      ...
      {
        image:
          "https://www.fillingpieces.com/cdn/shop/files/74927892057-1.jpg?v=1749652657&width=2120",
  ...
  FP002: {
    ...
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937619/ChatGPT_Image_29_apr_2025_16_40_03_trhpro.webp",
    description:
      "A sophisticated blazer tailored from premium merino wool with sustainable practices throughout the entire production chain.",
    size: "L",
    color: "Deep Burgundy",
    category: "Outerwear",
    ...
    impactClaims: ["Premium Merino", "Ethically Sourced"],
    similarProducts: [
      {
        image:
          "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelFour_bjqsyy.webp",
  ...
  FP003: {
    ...
    productImage:
      "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937032/AIModelOne_rdcgve.webp",
    description:
      "Elegant midi skirt made from sustainably sourced Tencel lyocell fibers.",
    size: "S",
    color: "Champagne",
    category: "Skirts",
    ...
    impactClaims: ["FSC Certified", "Closed Loop Production"],
    similarProducts: [
      {
        image:
          "https://res.cloudinary.com/dcdam15xy/image/upload/f_auto,q_auto/v1745937033/AIModelSix_btqjzc.webp",
