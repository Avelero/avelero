...
export const mockProducts: Record<string, DppData> = {
  ...
  'MRM001': {
    ...
    similarProducts: [
      ...
      },
      {
        ...
        price: 129.00,
        currency: '€',
        url: 'http://mrmarvis.com/nl/products/gazettes-the-cords',
      },
    ],
  },
  'MRM002': {
  ...
  'FP001': {
    ...
    journey: [
      {
        name: 'Cactus Cultivation',
        companies: [
          { name: 'Desert Innovations', location: 'Zacatecas, Mexico' },
        ],
      },
      {
        name: 'Material Processing',
        companies: [
          { name: 'Bio-Material Labs', location: 'Amsterdam, Netherlands' },
        ],
      },
      {
        name: 'Manufacturing',
        companies: [
          { name: 'Innovative Materials Lab', location: 'Rotterdam, Netherlands' },
        ],
      },
    ],
    impactMetrics: [
