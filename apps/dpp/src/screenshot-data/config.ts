...
/**
 * Screenshot fallback theme configuration.
 *
 * Used by the /ahw_preview_jja/ route when a brand hasn't configured their theme yet.
 * This can differ from demo-data/config.ts used for the homepage demo.
 */
export const screenshotThemeConfig: ThemeConfig = {
  branding: {
    headerLogoUrl:
