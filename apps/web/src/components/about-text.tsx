      ...
      <div className="w-full py-[45px] sm:py-[62px] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
        ...
        <div className="flex flex-col gap-4 text-small text-muted-foreground">
          <p>
            ...
            people buying the product. The EU's Digital Product Passport changes
            that. It gives brands a standardized way to share environmental
            impact data, material origins, and care information directly with
            consumers, at the product level.
          </p>
          <p>
            ...
            result is a digital passport that reads like a government form.
            Dense, unbranded, and ignored. If the goal is to help consumers make
            more conscious decisions, the passport needs to be something people
            actually want to read.
          </p>
          <p>
            Avelero exists because we believe environmental transparency should
            be accessible, well-designed, and built into the product from the
            start. Not bolted on as an afterthought. Not locked behind
            enterprise contracts. Available to every brand that wants to do this
            right.
          </p>
        </div>
      </div>
      ...
      <div className="w-full py-[45px] sm:py-[62px] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
        ...
        <div className="flex flex-col gap-4 text-small text-muted-foreground">
          <p>
            ...
            good. Typography, layout, color, spacing. Every passport generated
            through Avelero can be customized to feel like an extension of the
            brand it represents, not a third-party compliance page.
          </p>
          <p>
