...
export function ContactDrawer() {
    ...
    return (
        <Drawer.Root repositionInputs={false} open={isOpen} onOpenChange={setIsOpen}>
            ...
            <Drawer.Portal>
                <Drawer.Overlay className="fixed inset-0 z-50 bg-black/5" />
                <Drawer.Content className="fixed inset-x-3 bottom-0 mx-auto max-w-[369px] outline-none md:mx-auto md:w-full z-50">
                    <div 
                        className={cn(
