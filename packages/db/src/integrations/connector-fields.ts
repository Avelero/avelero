 ...
 *
 * @see packages/jobs/src/lib/integrations/connectors/shopify/schema.ts
 * @see packages/db/src/integrations/field-registry.ts
 */

import { fieldRegistry, type FieldCategory } from "./field-registry";
