...
export const productVariants = pgTable(
  ...
  (table) => ({
    ...
    productCreatedIdx: index("product_variants_product_created_idx").on(
      table.productId,
      table.createdAt,
    ),
    productUpdatedIdx: index("product_variants_product_updated_idx").on(
      table.productId,
      table.updatedAt,
    ),
    ...
    colorSizeIdx: index("product_variants_color_size_idx").on(
      table.colorId,
      table.sizeId,
    ),
    ...
    imageUrlIdx: index("product_variants_image_url_idx").on(
    ...
    productVariantsSelectForBrandMembers: pgPolicy(
    ...
    productVariantsInsertByBrandOwner: pgPolicy(
      "product_variants_insert_by_brand_owner",
      {
        as: "permissive",
        for: "insert",
        to: ["authenticated"],
    ...
    productVariantsUpdateByBrandOwner: pgPolicy(
      "product_variants_update_by_brand_owner",
      {
        as: "permissive",
        for: "update",
        to: ["authenticated"],
    ...
    productVariantsDeleteByBrandOwner: pgPolicy(
      "product_variants_delete_by_brand_owner",
      {
        as: "permissive",
        for: "delete",
        to: ["authenticated"],
