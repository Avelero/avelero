...
export type OperatorInsert = InferInsertModel<typeof schema.brandOperators>;
export type AttributeInsert = InferInsertModel<typeof schema.brandAttributes>;
export type AttributeValueInsert = InferInsertModel<
  typeof schema.brandAttributeValues
>;
export type ManufacturerInsert = InferInsertModel<
  typeof schema.brandManufacturers
>;
...
/**
 * Generate standard operator fixtures for a brand
 * Note: brandOperators uses displayName, not name
 */
export function createOperatorFixtures(brandId: string): OperatorInsert[] {
  return [
 ...
 */
export function createManufacturerFixtures(
  brandId: string,
): ManufacturerInsert[] {
  return [
 ...
 */
export function createFullCatalogFixtures(
  brandId: string,
): Omit<CatalogFixtures, "attributeValues"> {
  return {
    materials: createMaterialFixtures(brandId),
    seasons: createSeasonFixtures(brandId),
    tags: createTagFixtures(brandId),
    operators: createOperatorFixtures(brandId),
 ...
 */
export function createMinimalCatalogFixtures(
  brandId: string,
): Omit<CatalogFixtures, "attributeValues"> {
  return {
 ...
 */
export function createEmptyCatalogFixtures(): Omit<
  CatalogFixtures,
  "attributeValues"
> {
  return {
