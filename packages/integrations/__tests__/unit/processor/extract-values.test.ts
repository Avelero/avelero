...
describe("extractValues()", () => {
    ...
    test("basic product extraction", () => {
        const mappings = createMappings([
            ...
            { fieldKey: "product.description", path: "description", entity: "product" },
        ]);
    ...
    test("reference entity extraction (categoryId)", () => {
        ...
        const data = {
            category: { id: "gid://shopify/TaxonomyCategory/aa-1-2", name: "T-Shirts" },
        };
    ...
    test("product.tags goes to result.relations.tags", () => {
        const mapping: EffectiveFieldMapping = {
            ...
            definition: {
                ...
                entity: "product",
                sourceOptions: [
                    { key: "default", label: "Default", path: "tags" },
                ],
                defaultSource: "default",
                isRelation: true,
                relationType: "tags",
