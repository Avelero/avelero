...
describe("verifyShopifyWebhookHmac()", () => {
    ...
    describe("invalid HMAC signatures", () => {
        test("rejects completely wrong HMAC", () => {
            ...
            const result = verifyShopifyWebhookHmac(body, wrongHmac, TEST_CLIENT_SECRET);
        ...
        test("rejects HMAC signed with wrong secret", () => {
            ...
            const result = verifyShopifyWebhookHmac(body, hmacWithWrongSecret, TEST_CLIENT_SECRET);
        ...
        test("rejects HMAC for different body content", () => {
            ...
            const hmacForOriginal = generateShopifyHmac(originalBody, TEST_CLIENT_SECRET);

            const result = verifyShopifyWebhookHmac(modifiedBody, hmacForOriginal, TEST_CLIENT_SECRET);
        ...
        test("rejects hex-encoded HMAC (Shopify uses base64)", () => {
            ...
            const result = verifyShopifyWebhookHmac(body, hexHmac, TEST_CLIENT_SECRET);
        ...
        test("rejects HMAC with extra whitespace", () => {
            ...
            const result = verifyShopifyWebhookHmac(body, hmacWithWhitespace, TEST_CLIENT_SECRET);
        ...
        test("rejects HMAC with modified character", () => {
            ...
            const result = verifyShopifyWebhookHmac(body, tamperedHmac, TEST_CLIENT_SECRET);
    ...
    describe("HMAC format", () => {
        ...
        test("generated HMAC has consistent length", () => {
            ...
            const hmac3 = generateShopifyHmac("a much longer body content here", TEST_CLIENT_SECRET);
...
describe("Shopify Compliance Webhook Scenarios", () => {
    ...
    describe("shop/redact", () => {
        ...
        test("minimal payload is accepted", () => {
            ...
            const result = verifyShopifyWebhookHmac(minimalPayload, hmac, TEST_CLIENT_SECRET);
