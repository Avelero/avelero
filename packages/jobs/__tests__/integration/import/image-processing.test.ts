...
import { ExcelBuilder, basicProduct, completeProduct, productWithOverrides } from "@v1/testing/bulk-import";
...
describe("Image Processing", () => {
    ...
    describe("Valid Image URLs", () => {
        it("accepts valid HTTPS image URL", async () => {
            ...
            expect(parseResult.products[0]?.imagePath).toBe("https://example.com/images/product.jpg");
        });
        ...
        it("stores image URL in product data", async () => {
            ...
            expect(parseResult.products[0]?.imagePath).toBe("https://example.com/images/hoodie.jpg");
        });
    });
    ...
    describe("Variant-Level Image Overrides", () => {
        it("handles variant-level image override in child rows", async () => {
            ...
            expect(parseResult.products[0]?.imagePath).toBe("https://example.com/parent.jpg");
