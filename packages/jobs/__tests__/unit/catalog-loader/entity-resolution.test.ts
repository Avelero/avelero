...
function createMockCatalog(overrides?: Partial<BrandCatalog>): BrandCatalog {
    return {
        ...
        attributeValues: new Map([
            ...
            ["attr_001:red", { id: "val_001", name: "Red", attributeId: "attr_001", attributeName: "Color" }],
            ["attr_001:blue", { id: "val_002", name: "Blue", attributeId: "attr_001", attributeName: "Color" }],
            ["attr_002:small", { id: "val_003", name: "Small", attributeId: "attr_002", attributeName: "Size" }],
            ["attr_002:medium", { id: "val_004", name: "Medium", attributeId: "attr_002", attributeName: "Size" }],
            ["attr_002:large", { id: "val_005", name: "Large", attributeId: "attr_002", attributeName: "Size" }],
        ]),
        tags: new Map([
            ["bestseller", "tag_001"],
            ["new arrival", "tag_002"],
        ...
        taxonomyValues: new Map([
            ...
            ["tax_attr_001:red", { id: "tax_val_001", name: "Red", attributeId: "tax_attr_001", friendlyId: "red" }],
            ["tax_attr_001:blue", { id: "tax_val_002", name: "Blue", attributeId: "tax_attr_001", friendlyId: "blue" }],
            ["tax_attr_002:small", { id: "tax_val_003", name: "Small", attributeId: "tax_attr_002", friendlyId: "small" }],
            ["tax_attr_002:medium", { id: "tax_val_004", name: "Medium", attributeId: "tax_attr_002", friendlyId: "medium" }],
        ]),
        ...overrides,
    };
}
...
describe("Catalog Loader - Entity Resolution", () => {
    ...
    describe("Operator/Facility Lookup", () => {
        it("looks up facility/operator by display name", () => {
            ...
            expect(lookupOperatorId(catalog, "Textile Mill Portugal")).toBe("fac_002");
        });
    ...
    describe("Manufacturers Lookup", () => {
        it("looks up manufacturer by name", () => {
            ...
            expect(catalog.manufacturers.get("eco fashion manufacturing")).toBe("mfr_002");
        });
