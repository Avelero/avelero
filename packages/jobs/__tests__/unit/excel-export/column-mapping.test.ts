...
describe("getAttributeByIndex()", () => {
    it("returns correct attribute by sort order (1-indexed)", () => {
        ...
        expect(getAttributeByIndex(attributes, 1)).toEqual({ name: "Color", value: "Red" });
        expect(getAttributeByIndex(attributes, 2)).toEqual({ name: "Size", value: "Medium" });
        expect(getAttributeByIndex(attributes, 3)).toEqual({ name: "Material", value: "Cotton" });
    });
    ...
    it("handles unsorted input array", () => {
        ...
        expect(getAttributeByIndex(attributes, 1)).toEqual({ name: "Color", value: "Green" });
        expect(getAttributeByIndex(attributes, 2)).toEqual({ name: "Season", value: "Winter" });
        expect(getAttributeByIndex(attributes, 3)).toEqual({ name: "Size", value: "Large" });
    });
