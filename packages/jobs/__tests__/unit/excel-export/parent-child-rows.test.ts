...
function createTestVariant(overrides: Partial<ExportVariantData> = {}): ExportVariantData {
    return {
        upid: "UPID-001",
        barcode: null,
        sku: null,
...
function createTestProduct(overrides: Partial<ExportProductData> = {}): ExportProductData {
    return {
        id: "product-001",
        name: "Test Product",
