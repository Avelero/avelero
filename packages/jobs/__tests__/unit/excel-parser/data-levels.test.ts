...
describe("Excel Parser - Data Levels", () => {
    ...
    it("extracts variant-level fields from all rows", async () => {
        ...
        expect(v1.attributes[0]).toEqual({ name: "Size", value: "S", sortOrder: 0 });
        ...
        expect(v2.attributes[0]).toEqual({ name: "Size", value: "M", sortOrder: 0 });
        expect(v2.attributes[1]).toEqual({ name: "Color", value: "Blue", sortOrder: 1 });
    });
