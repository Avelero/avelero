/*
  Generated from provided dump. Single source of truth for country info.
  Keys are ISO alpha-2 codes. Values include code, unicode, name, emoji.
*/
const countries = {
...
export { countries };
export const allCountries: Array<Pick<Country, "code" | "name" | "emoji">> = Object.values(countries).map(
  (c) => ({ code: c.code, name: c.name, emoji: c.emoji }),
);