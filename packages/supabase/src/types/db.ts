    ...
    Tables: {
      ...
      brand_billing_invoices: {
        Row: {
          ...
          last_synced_from_stripe_at: string | null;
          managed_by_avelero: boolean;
          paid_at: string | null;
          recipient_address_city: string | null;
          recipient_address_country: string | null;
          recipient_address_line_1: string | null;
          recipient_address_line_2: string | null;
          recipient_address_postal_code: string | null;
          recipient_address_region: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "brand_billing_invoices_brand_id_brands_id_fk";
            columns: ["brand_id"];
            isOneToOne: false;
            referencedRelation: "brands";
            referencedColumns: ["id"];
