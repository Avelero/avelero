  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:w-[480px] lg:w-[560px]",
      },
    },
    defaultVariants: {
      side: "right",
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "h-14 px-6 flex items-center justify-end bg-[#F7F7FF] border-t border-border",
      className,
    )}
    {...props}
  />
