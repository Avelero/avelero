...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ebshgnuavsacpplatsqt.supabase.co';
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVic2hnbnVhdnNhY3BwbGF0c3F0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NDc0MjEyNywiZXhwIjoyMDcwMzE4MTI3fQ.p_OXWdCyJfPUhdwHXVHU8q1h6_bLDk1OTqiQLAe70eg';
...
async function checkLatestImport() {
  try {
    ...
    console.log('Total Staging Products:', (createCount || 0) + (updateCount || 0));
